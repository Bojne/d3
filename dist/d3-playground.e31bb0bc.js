...
var _ticks = _interopRequireDefault(require("./ticks.js"));
...
function _default() {
  ...
  function histogram(data) {
    ...
    if (!Array.isArray(tz)) {
      tz = +tz;
      if (domain === _extent.default) [x0, x1] = (0, _nice.default)(x0, x1, tz);
      tz = (0, _ticks.default)(x0, x1, tz);
...
function sort(values, comparator = _ascending.default) {
  if (typeof values[Symbol.iterator] !== "function") throw new TypeError("values is not iterable");
  return Array.from(values).sort(comparator);
}
},{"./ascending.js":"../../../node_modules/d3-array/src/ascending.js"}],"../../../node_modules/d3-array/src/difference.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./contours.js":"../../../node_modules/d3-contour/src/contours.js","./density.js":"../../../node_modules/d3-contour/src/density.js"}],"../../../node_modules/delaunator/index.js":[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=/d3-playground.e31bb0bc.js.map